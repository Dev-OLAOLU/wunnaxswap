...
WUNNA.DERIV_CLASSES = [
  ...
  { id: "derived", label: "Derived (Deriv)" },
...
WUNNA.DERIVATIVES = [
  ...
  // Deriv synthetic / derived indices (Options dashboard style markets)
  deriv("R_10", "Volatility 10 Index", 6200.12, 0.15, "derived", {
    product: "OPTIONS",
    quote: "USD",
    leverageMax: 1,
    funding: 0,
  ...
  deriv("R_25", "Volatility 25 Index", 8500.4, -0.22, "derived", {
    product: "OPTIONS",
    quote: "USD",
    leverageMax: 1,
    funding: 0,
  ...
  deriv("R_50", "Volatility 50 Index", 210.55, 0.41, "derived", {
    product: "OPTIONS",
    quote: "USD",
    leverageMax: 1,
    funding: 0,
  ...
  deriv("R_75", "Volatility 75 Index", 98000.0, 0.08, "derived", {
    product: "OPTIONS",
    quote: "USD",
    leverageMax: 1,
    funding: 0,
  ...
  deriv("R_100", "Volatility 100 Index", 1450.3, -0.18, "derived", {
    product: "OPTIONS",
    quote: "USD",
    leverageMax: 1,
    funding: 0,
  ...
  deriv("BOOM1000", "Boom 1000 Index", 11200.5, 0.55, "derived", {
    product: "OPTIONS",
    quote: "USD",
    leverageMax: 1,
    funding: 0,
  ...
  deriv("CRASH1000", "Crash 1000 Index", 8900.2, -0.35, "derived", {
    product: "OPTIONS",
    quote: "USD",
    leverageMax: 1,
    funding: 0,
  ...
  // Crypto perps (linked to crypto book / Deriv crypto symbols when available)
