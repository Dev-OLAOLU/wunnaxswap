...
(function (global) {
  ...
  var EN = {
    ...
    login_help: "Help",
    login_tagline_1: "Find cheaper buys.",
    login_tagline_2: "Stronger sells.",
    login_sub:
      "Wunnaxswap is built for arbitrage — scan multi-venue quotes, spot spreads, and route trades where the price works harder for you.",
    login_arb_live: "Arbitrage scanner",
    login_tab_spreads: "Spreads",
    login_tab_routes: "Routes",
    login_foot: "Buy low · Sell high · Multi-exchange",
    login_open_scanner: "Open scanner →",
    login_welcome: "Welcome back",
    login_welcome_sub: "Log in to unlock the arbitrage scanner and trading tools",
  ...
  var PACKS = {
    ...
    es: Object.assign(clone(EN), {
      ...
      login_tagline_1: "Compra más barato.",
      login_tagline_2: "Vende más alto.",
      login_sub:
        "Wunnaxswap está hecho para el arbitraje: compara cotizaciones multi-venue, detecta spreads y enruta donde el precio rinde más.",
      login_arb_live: "Escáner de arbitraje",
      login_tab_spreads: "Spreads",
      login_tab_routes: "Rutas",
      login_foot: "Compra bajo · Vende alto · Multi-exchange",
      login_open_scanner: "Abrir escáner →",
      login_welcome: "Bienvenido de nuevo",
      login_welcome_sub: "Inicia sesión para desbloquear el escáner de arbitraje y las herramientas",
    ...
    fr: Object.assign(clone(EN), {
      ...
      login_tagline_1: "Achetez moins cher.",
      login_tagline_2: "Vendez plus fort.",
      login_sub:
        "Wunnaxswap est conçu pour l'arbitrage — comparez les venues, repérez les spreads et routez là où le prix travaille pour vous.",
      login_arb_live: "Scanner d'arbitrage",
      login_tab_spreads: "Spreads",
      login_tab_routes: "Routes",
      login_foot: "Acheter bas · Vendre haut · Multi-exchange",
      login_open_scanner: "Ouvrir le scanner →",
      login_welcome: "Bon retour",
      login_welcome_sub: "Connectez-vous pour débloquer le scanner d'arbitrage",
    ...
    zh: Object.assign(clone(EN), {
      ...
      login_tagline_1: "买得更便宜。",
      login_tagline_2: "卖得更强。",
      login_sub: "Wunnaxswap 专注套利——扫描多交易所报价、发现价差，把交易路由到更有利的价格。",
      login_arb_live: "套利扫描器",
      login_tab_spreads: "价差",
      login_tab_routes: "路径",
      login_foot: "低买 · 高卖 · 多交易所",
      login_open_scanner: "打开扫描器 →",
      login_welcome: "欢迎回来",
      login_welcome_sub: "登录以解锁套利扫描器与交易工具",
    ...
    ar: Object.assign(clone(EN), {
      ...
      login_tagline_1: "اشترِ بسعر أقل.",
      login_tagline_2: "بِع بسعر أقوى.",
      login_sub: "صُممت Wunnaxswap للمراجحة — امسح عروض المنصات، اكتشف الفروق، ووجّه الصفقات حيث يعمل السعر لصالحك.",
      login_arb_live: "ماسح المراجحة",
      login_tab_spreads: "الفروق",
      login_tab_routes: "المسارات",
      login_foot: "اشترِ منخفض · بِع مرتفع · متعدد المنصات",
      login_open_scanner: "افتح الماسح →",
      login_welcome: "مرحبًا بعودتك",
      login_welcome_sub: "سجّل الدخول لفتح ماسح المراجحة وأدوات التداول",
    ...
    hi: Object.assign(clone(EN), {
      ...
      login_tagline_1: "सस्ता खरीदें।",
      login_tagline_2: "मज़बूत बेचें।",
      login_sub: "Wunnaxswap आर्बिट्राज के लिए बना है — मल्टी-एक्सचेंज कोट्स स्कैन करें, स्प्रेड देखें, बेहतर कीमत पर रूट करें।",
      login_arb_live: "आर्बिट्राज स्कैनर",
      login_welcome: "वापसी पर स्वागत है",
      login_welcome_sub: "आर्बिट्राज स्कैनर खोलने के लिए लॉग इन करें",
    ...
    pt: Object.assign(clone(EN), {
      ...
      login_tagline_1: "Compre mais barato.",
      login_tagline_2: "Venda mais forte.",
      login_sub: "Wunnaxswap é feito para arbitragem — compare venues, encontre spreads e roteie onde o preço rende mais.",
      login_arb_live: "Scanner de arbitragem",
      login_welcome: "Bem-vindo de volta",
      login_welcome_sub: "Entre para liberar o scanner de arbitragem",
    ...
    de: Object.assign(clone(EN), {
      ...
      login_tagline_1: "Günstiger kaufen.",
      login_tagline_2: "Stärker verkaufen.",
      login_sub: "Wunnaxswap ist für Arbitrage gebaut — Multi-Venue-Kurse scannen, Spreads finden, smarter routen.",
      login_arb_live: "Arbitrage-Scanner",
      login_welcome: "Willkommen zurück",
      login_welcome_sub: "Melde dich an, um den Arbitrage-Scanner freizuschalten",
    ...
    ja: Object.assign(clone(EN), {
      ...
      login_tagline_1: "安く買う。",
      login_tagline_2: "強く売る。",
      login_sub: "Wunnaxswapは裁定取引のため — 複数取引所の気配をスキャンし、スプレッドを見つけ、有利な価格へルーティングします。",
      login_arb_live: "裁定スキャナー",
      login_welcome: "おかえりなさい",
      login_welcome_sub: "ログインして裁定スキャナーを利用",
    ...
    ko: Object.assign(clone(EN), {
      ...
      login_tagline_1: "더 싸게 사고.",
      login_tagline_2: "더 강하게 팔고.",
      login_sub: "Wunnaxswap은 차익거래용 — 다중 거래소 호가를 스캔하고 스프레드를 찾아 유리한 가격으로 라우팅합니다.",
      login_arb_live: "차익 스캐너",
      login_welcome: "다시 오신 것을 환영합니다",
      login_welcome_sub: "차익 스캐너를 쓰려면 로그인하세요",
